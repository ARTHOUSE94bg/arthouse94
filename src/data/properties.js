...
export const properties = [
  {
    ...
    featuresEn: ["Parking space", "Elevator", "Video surveillance", "Air conditioning", "Panoramic windows"],
  ...
  },
  {
    ...
    features: ["Собствен двор", "Тераса", "Саниран", "Централно отопление", "Гараж"],
    featuresEn: ["Private yard", "Terrace", "Thermally renovated", "Central heating", "Garage"],
  ...
  },
  {
    ...
    featuresEn: ["Electricity", "Water", "Asphalt road", "Panoramic view", "Regulated plot"],
  ...
  },
  {
    ...
    featuresEn: ["Sea view", "Parking space", "Swimming pool", "Fitness", "Furnished"],
  ...
  },
  {
    ...
    features: ["Камина", "Джакузи", "Барбекю", "С паркинг", "WiFi"],
    featuresEn: ["Fireplace", "Jacuzzi", "Barbecue", "With parking", "WiFi"],
  ...
  },
  {
    ...
    features: ["Обзаведен", "Климатик", "Интернет", "Централна локация"],
    featuresEn: ["Furnished", "Air conditioning", "Internet", "Central location"],
  ...
  },
  {
    ...
    features: ["Морска гледка", "Регулиран", "Вода", "Ток", "Ново строителство"],
    featuresEn: ["Sea view", "Regulated plot", "Water", "Electricity", "New construction"],
  ...
  },
  {
    ...
    featuresEn: ["Garage", "Security", "Playground", "New construction", "Luxury"],
...
/**
 * Удобства – само тези опции в админ (български + английски за сайта).
 * Редът е като в чеклиста на брокера.
 */
export const FEATURE_OPTIONS = [
  { bg: 'Паркомясто', en: 'Parking space' },
  { bg: 'Асансьор', en: 'Elevator' },
  { bg: 'Видеонаблюдение', en: 'Video surveillance' },
  { bg: 'Климатик', en: 'Air conditioning' },
  { bg: 'Панорамни прозорци', en: 'Panoramic windows' },
  { bg: 'С преход', en: 'Walk-through layout' },
  ...
  { bg: 'Саниран', en: 'Thermally renovated' },
  { bg: 'В затворен комплекс', en: 'Gated community' },
  { bg: 'За ремонт', en: 'Needs renovation' },
  ...
  { bg: 'Вода', en: 'Water' },
  { bg: 'Асфалтов път', en: 'Asphalt road' },
  { bg: 'Панорамна гледка', en: 'Panoramic view' },
  { bg: 'Регулиран', en: 'Regulated plot' },
