...
function transformProperty(row) {
  ...
  return {
    ...
    gaz: Boolean(row.gaz),
    tec: Boolean(row.tec),
    hidePricePerSqm: Boolean(row.hide_price_per_sqm),
    priceIncludesVat: Boolean(row.price_includes_vat),
    hidePriceVat: Boolean(row.hide_price_vat),
...
function transformToSupabase(property) {
  ...
  const result = {
    ...
    hide_price_per_sqm: Boolean(property.hidePricePerSqm),
    price_includes_vat: Boolean(property.priceIncludesVat),
    hide_price_vat: Boolean(property.hidePriceVat),
...
export async function cloneProperty(id) {
  ...
  const clonePayload = {
    ...
    hidePriceVat: prop.hidePriceVat,
